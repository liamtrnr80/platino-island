            ...
            <div class="uk-child-width-1-3@m uk-grid-small uk-grid-match" uk-grid>
                <a href="flawless-liquid-foundation.php" class="uk-display-block uk-card uk-card-default uk-link-toggle">
                    <div class="uk-card-media-top">
                        <img class="uk-align-center" src="img/1FLAWLESS LIQUID FOUNDATION.jpg" alt="Flawless Liquid Foundation" width="250" height="250">
                    </div>
                ...
                <a href="flawless-concealer.php" class="uk-display-block uk-card uk-card-default uk-link-toggle"> 
                    ...
                    <div class="uk-card-body">
                        <div class="uk-text-small">Flawless Concealer</div>
                        <div class="uk-text-meta">$32.95</div>
                    </div>
                </a>
                <!-- Perfecting Concealer  -->
                <a href="perfecting-concealer.php" class="uk-display-block uk-card uk-card-default uk-link-toggle"> 
                    <div class="uk-card-media-top">
                        <img class="uk-align-center" src="img/8 PERFECTING CONCEALER.jpg" alt="airbrush mineral primer" width="250" height="250">
                    </div>
                    <div class="uk-card-body">
                        <div class="uk-text-small">Perfecting Concealer</div>
                ...
                <a href="virgin-blush.php" class="uk-display-block uk-card uk-card-default uk-link-toggle"> 
                    <div class="uk-card-media-top">
                        <img class="uk-align-center" src="img/9VIRGIN BLUSH.jpg" alt="airbrush mineral primer" width="250" height="250">
                    </div>
                    <div class="uk-card-body">
                        <div class="uk-text-small">Virgin Blush</div>
                        <div class="uk-text-meta">$29.95</div>
                    </div>
                </a>
                ...
                <a href="airbrush-mineral-primer.php" class="uk-display-block uk-card uk-card-default uk-link-toggle"> 
                    <div class="uk-card-media-top">
                        <img class="uk-align-center" src="img/10-AIRBRUSH-MINERAL-PRIMER.jpg" alt="Airbrush Mineral Primer" width="250" height="250">
                    </div>
                    <div class="uk-card-body">
                        <div class="uk-text-small">Airbrush Mineral Primer</div>
                        <div class="uk-text-meta">$29.95</div>
                    </div>
                </a>
                
                <!-- Perfecting Eye Primer -->
                <a href="perfecting-eye-primer.php" class="uk-display-block uk-card uk-card-default uk-link-toggle"> 
                    <div class="uk-card-media-top">
                        <img class="uk-align-center" src="img/11 PERFECTING EYE PRIMER.jpg" alt="Perfecting Eye Primer" width="250" height="250">
                    </div>
                    <div class="uk-card-body">
                        <div class="uk-text-small">Perfecting Eye Primer</div>
                        <div class="uk-text-meta">$22.95</div>
                    </div>
                </a>
                <!-- Pressed Mattifying Mineral Veil -->
                <a href="pressed-mattifying-mineral-veil.php" class="uk-display-block uk-card uk-card-default uk-link-toggle"> 
                    <div class="uk-card-media-top">
                        <img class="uk-align-center" src="img/12 PRESSED MATTIFYING MINERAL VEIL.jpg" alt="Pressed Mattifying Mineral Veil" width="250" height="250">
                    </div>
                    <div class="uk-card-body">
                        <div class="uk-text-small">Pressed Mattifying Mineral Veil</div>
                        <div class="uk-text-meta">$32.95</div>
                    </div>
                </a>
                <!-- Mineral Finishing Powder -->
                <a href="mineral-finishing-powder.php" class="uk-display-block uk-card uk-card-default uk-link-toggle"> 
                    <div class="uk-card-media-top">
                        <img class="uk-align-center" src="img/13 MINERAL FINISHING POWDER.jpg" alt="Mineral Finishing Powder" width="250" height="250">
                    </div>
                    <div class="uk-card-body">
                        <div class="uk-text-small">Mineral Finishing Powder</div>
                        <div class="uk-text-meta">$41.95</div>
                    </div>
                </a>
            </div>
        </div>
